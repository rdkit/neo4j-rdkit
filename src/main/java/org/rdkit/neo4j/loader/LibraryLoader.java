...
public class LibraryLoader {
  ...
  public static void loadLibraries() {
    ...
    final List<String> missingLibraries = findLibraries(libraries);
    LibraryMover.moveMissingLibraries(missingLibraries, folder);

    loadLibraries(libraries);
  }

  private static String getFolder(String platform) {
    String packageName = LibraryLoader.class.getPackage().toString();
    return String.format("%s.%s", packageName, platform);
  }


  private static List<String> findLibraries(String[] libraries) {
